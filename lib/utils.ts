...
// Type for the tree structure: nested objects where leaves are null (files)
type TreeNode = {
  [key: string]: TreeNode | null;
};

// Type for the tree items (can be a string or nested array)
// Exported to be shared across components
